...
<header id="cabecalho">
    ...
    <div id="fundoplaystation">
        <img src="view/imagens/playstation-logo-background-4k-wallpaper-uhdpaper.com-118@0@e.jpg"/>
    </div>

    <section id="corpoplaystation">
        <section class="groupcards">
            <div class="cards">
                ...
                <button class="comprar" onclick="adicionarAoCarrinho('CyberPunk 2077', 'R$199,90', 'view/imagens/stretched-1366-768-928956.jpg')">Adicionar ao Carrinho</button>
            </div>
            <div class="cards">
                ...
                <button class="comprar" onclick="adicionarAoCarrinho('Hogwarts Legacy', 'R$219,90', 'view/imagens/stretched-1366-768-1221680.jpg')">Adicionar ao Carrinho</button>
            </div>
            <div class="cards">
                ...
                <button class="comprar"onclick="adicionarAoCarrinho('Elder Ring', 'R$249,90', 'view/imagens/stretched-1366-768-1291883.png')">Adicionar ao Carrinho</button>
            </div>
            <div class="cards">
                ...
                <p class="titulojogolongo"><br></p>
                <p class="preco">R$199,90</p>
                <button class="comprar" onclick="adicionarAoCarrinho('Resident Evil 4 Remake', 'R$199,90', 'view/imagens/stretched-1366-768-1305512.png')">Adicionar ao Carrinho</button>
            </div>
            <div class="cards">
                ...
                <button class="comprar" onclick="adicionarAoCarrinho('The Witcher 3', 'R$209,90', 'view/imagens/stretched-1366-768-424912.jpg')">Adicionar ao Carrinho</button>
            </div>
            <div class="cards">
